...
public:
	...
	inline SDL_Renderer* getPtr() const noexcept;
	...
	void drawTexture(const Texture& texture, const SDL_Rect* srcrect = nullptr, const SDL_Rect* dstrect = nullptr) const noexcept;
	void drawTextureEx(const Texture& texture, const SDL_Rect* srcrect = nullptr, const SDL_Rect* dstrect = nullptr, const float angle = 0.0f, const SDL_Point* center = nullptr, const SDL_RendererFlip flip = SDL_FLIP_NONE) const noexcept;
